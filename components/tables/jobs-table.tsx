  ...
  return (
    <div className="glass-card rounded-3xl overflow-hidden">
      ...
      >
        {/* LEFT */}
        <div>
          <h2 className="text-2xl font-bold">Pending Billing Jobs</h2>
        ...
        <div className="flex flex-col gap-3 w-full lg:w-auto">
          ...
          >
            ...
            <option value="pending-asc">Lowest Pending</option>
          ...
          {/* EXPORT BUTTON */}
          <button
            onClick={() => exportStyledExcel(filteredJobs)}
            className="
          ...
          <tbody>
            {filteredJobs.map((job, index) => (
              ...
              >
                ...
                <td className="p-4">
                  <span className="bg-[#00FF28]/20 text-[#00FF28] px-3 py-1 rounded-full text-xs font-semibold">
                    {job.prefix}
                  </span>
                </td>
                ...
                <td className={`p-4 font-bold text-lg ${getColor(job.pendingDays)}`}>
                  {job.pendingDays ?? "-"}
                </td>
